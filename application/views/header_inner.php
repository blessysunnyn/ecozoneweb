    ...
    <div class="th-menu-wrapper visib">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="<?php echo base_url();?>"><img src="assets/img/logo.png"  alt="Eco Zone"></a>
            </div>
                ...
                <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links">
                            <ul>
                                <li style="color:#fff;font-weight: 600;font-size:16px"><i class="fas fa-location-dot"></i>P.O.Box: 31058, Doha – Qatar</li>
                                <li><i class="fas fa-headset"></i> <a style="color:#fff;font-weight: 600;font-size:16px" href="tel:+97474717154">+974 74717154</a></li>
                    ...
                    <div class="col-auto">
                        <div class="header-links">
                            <ul>
                                <li  class="d-none d-md-inline-block"><i class="fas fa-messages"></i> <a style="color:#fff;font-weight: 600;font-size:16px" href="mailto:ecozoneqatar@gmail.com">ecozoneqatar@gmail.com</a></li>
                                <li style="color:#fff;font-weight: 600;font-size:16px"><i class="fas fa-clock"></i> Sun to Thur: 8.00 am - 7.00 pm</li>
                ...
                <div class="col-auto d-none d-lg-block">
                    ...
                    <div class="col-auto">
                        <div class="header-links">
                            <ul>
                                <li  class="d-none d-md-inline-block"><i class="fas fa-messages"></i> <a style="color:#fff;font-weight: 600;font-size:16px" href="mailto:ecozoneqatar@gmail.com">ecozoneqatar@gmail.com</a></li>
                                <li style="color:#fff;font-weight: 600;font-size:16px"><i class="fas fa-headset"></i> <a style="color:#fff;font-weight: 600;font-size:16px" href="tel:+97474717154">+974 74717154</a></li>
                                <!-- <li><i class="fas fa-user"></i> <a href="contact.html">Sign In / Register</a></li> -->
                            </ul>
                        </div>
                    </div>
