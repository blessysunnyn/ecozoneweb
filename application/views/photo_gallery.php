           ...
           <!-- <div class="filter-menu style2 mt-0 indicator-active filter-menu-active">
            ...
            <div class="row gy-30 filter-active overlay-direction load-more-active">
                ...
                <div class="cat1 cat5 col-xl-3 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img1.png">
                            <img src="assets/img/gallery/img1.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat3 cat5 col-xl-6 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img3.png">
                            <img src="assets/img/gallery/img3.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat2 col-xl-6 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img4.png">
                            <img src="assets/img/gallery/img4.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat4 cat3 col-xl-3 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img11.png">
                            <img src="assets/img/gallery/img11.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat1 col-xl-3 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img5.png">
                            <img src="assets/img/gallery/img5.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat5 cat4 col-xl-3 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img12.png">
                            <img src="assets/img/gallery/img12.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat2 col-xl-6 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img13.png">
                            <img src="assets/img/gallery/img13.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat1 cat3 col-xl-3 col-md-6 filter-item">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img14.png">
                            <img src="assets/img/gallery/img14.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat4 cat3 col-xl-3 col-md-6 filter-item d-none">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img17.png">
                            <img src="assets/img/gallery/img17.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat3 cat5 col-xl-6 col-md-6 filter-item d-none">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img18.png">
                            <img src="assets/img/gallery/img18.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
                ...
                <div class="cat2 col-xl-6 col-md-6 filter-item d-none">
                    <div class="gallery-card">
                        <a class="box-img popup-image" href="assets/img/gallery/img19.png">
                            <img src="assets/img/gallery/img19.png" alt="gallery image">
                            <div class="box-content">
                                <span class="box-btn"><i class="fal fa-plus"></i></span>
                            </div>
                        </a>
